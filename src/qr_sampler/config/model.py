...
class QRSamplerConfig(BaseSettings):
    ...
    fixed_temperature: float = Field(
        ...
        description=(
            ...
            "preset overrides this with the HVD-champion dynamic strategy "
            "(temperature_strategy=hvh_drift, t_base 1.53 with EMA-tracked "
            "entropy/varentropy drift terms). Earlier default of 0.7 was inherited "
