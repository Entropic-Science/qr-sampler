...
class QRSamplerConfig(BaseSettings):
    ...
    fixed_temperature: float = Field(
        ...
        description=(
            ...
            "preset overrides this with the GDT bell-lift dynamic strategy "
            "(temperature_strategy=gdt, t_base 0.9 with a bell-curve boost "
            "over normalized entropy). Earlier default of 0.7 was inherited "
